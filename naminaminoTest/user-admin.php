                ...
                <main class="container mt-4">
                    ...
                    <div class="center">
                        <?php if (count($users) > 0) : ?>
                            <!-- 取得した情報をテーブル形式で表示 -->
                            <table border="1" id="userTable" class="table table-bordered">
                                <tr>
                                    <th>ユーザーID</th>
                                    <th>ユーザー名</th>
                                    <th>メールアドレス</th>
                                ...
                                <?php foreach ($users as $user) : ?>
                                    <tr>
                                        ...
                                        <!-- ボタンにユーザーIDを渡す -->
                                        <td>
                                            <button type='button' onclick="window.location.href='user-detail.php?user_id=<?php echo htmlspecialchars($user['user_id']); ?>'" class='btn btn-outline-success'>詳細</button>
                                        </td>
                                    </tr>
                                <?php endforeach; ?>
                            </table>
                        ...
                        <?php endif; ?>
                        <br><br>
                        <!--<button id="backButton" class="btn btn-outline-success">商品一覧へ戻る</button>-->
