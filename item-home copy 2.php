    ...
    */
    ...
    public function execute(){
        ...
        $details_query = "
            ...
            INNER JOIN
                blands ON products.bland_id = blands.bland_id
            INNER JOIN
                categorys ON products.category_id = categorys.category_id
        ";
        $details_result = $mysqli->query($details_query);

        if (!$details_result) {
            die("Details query failed: " . $mysqli->error);
        }
    ...
    public function display(){
        ...
        <?php
          ...
          foreach ($this->details_products as $details_product) {
            ...
            $bland_name = $details_product['bland_name'];
            ...
            echo '<h3 class="card-title">' . $bland_name . '</h3>';
