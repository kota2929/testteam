...
<div class="btn-back">
	...
	<button type="button" onclick="window.location.href='item-admin.php'" class="btn btn-outline-success">商品とブランドの登録</button>
	<button type="button" onclick="window.location.href='item-detail.php'" class="btn btn-outline-success">商品の編集・削除</button>
