        ...
        <main class="container mt-4">
            ...
            <div class="center">
                ...
                if ($result->num_rows > 0) {
                    ...
                    echo "<tr><th>商品ID</th><th>商品名</th><th>説明</th><th>値段</th><th>ジャンル</th><th>季節</th><th>ブランド</th><th>カテゴリー</th><th>編集・削除</th></tr>";
                    //カテゴリー順に並んでいる
                    while ($row = $result->fetch_assoc()) {
                        ...
                        echo "<td><button type='button' onclick=\"window.location.href='item-edit-delete.php?product_id=" . htmlspecialchars($row['product_id']) . "'\" class='btn btn-outline-success'>編集・削除</button></td>";
                        echo "</tr>";
                    }
                    echo "</table>";
                } else {
